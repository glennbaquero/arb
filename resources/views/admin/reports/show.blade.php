...
@section('meta:title', $item->file_name)
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">{{ $item->file_name }}</a></li>
                </ol>
            </div>
        </div>
    </section>
    
    <page-pagination fetch-url="{{ route('admin.documents.fetch-pagination', $item->id) }}"></page-pagination>
            ...
            <div class="card-body">
                <div class="tab-content">
                    <div class="tab-pane show active" id="tab1">
                        <documents-view
                        fetch-url="{{ route('admin.documents.fetch-item', $item->id) }}"
                        submit-url=""
                        :read-only="true"
                        ></documents-view>
                    </div>
                    <div class="tab-pane" id="tab2">
                        ...
                        disabled
                        no-action
                        fetch-url="{{ route('admin.activity-logs.fetch.documents', $item->id) }}"
                        ></activity-log-table>
                    </div>
                </div>
            </div>
